	...
	<header>
		...
		?>
			<h1 class="entry-title p-name">
				<a class="u-url" href="<?php the_permalink(); ?>" title="<?php echo indieweb_publisher_post_link_title(); ?>" rel="bookmark"><?php the_title(); ?></a>
			</h1>
		<?php } ?>
	</header>
			...
			<?php if ( has_post_thumbnail() && in_array( get_post_format(), array( 'gallery', false ) ) ) : ?>
				<?php the_post_thumbnail( 'indieweb_publisher_post_frontpage', array( 'class' => 'alignleft' ) ); ?>
			<?php endif; ?>
